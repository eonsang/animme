...
const Chart = ({ averageAnnualSales, secondaryMarketShareByValue, secondaryMarketShareByVolume,
  tradeVolumesSector,
  marketShareSector
}) => {
  return (
      ...
      <Section>
        <Wrap>
          ...
          <div className={'chartbg chartbg--3'}>
            <div className={'flex'}>
              <div className="col">
                <SecondaryMarketShareChart
                  values={secondaryMarketShareByValue}
                  title={'Market share by Value'}
                />
              </div>
              <div className="col">
                <SecondaryMarketShareChart
                  values={secondaryMarketShareByVolume}
